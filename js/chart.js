...
var optionsCircle = {
    ...
    series: [71, 63],
    labels: ["Private Trans", "Public Trans"],
    legend: {
        show: true,
        position: "left",
        offsetX: -30,
...
window.setInterval(function() {
    ...
    chartColumn.updateSeries([{
        data: [
            ...chartColumn.w.config.series[0].data, [chartColumn.w.globals.maxX + 300000, getRandom()],
        ],
    }, ]);

    chartLine.updateSeries([{
            data: [
                ...chartLine.w.config.series[0].data, [chartLine.w.globals.maxX + 300000, getRandom()],
            ],
        },
        {
            data: [
                ...chartLine.w.config.series[1].data, [chartLine.w.globals.maxX + 300000, getRandom()],
            ],
        },
    ]);
